    ...
    <div className="flex flex-col h-screen w-screen bg-gray-950 overflow-hidden">
      ...
      <div className="flex-1 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full">
          ...
          {/* Two stacked charts - responsive layout */}
          ...
          <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg border border-gray-700 p-4 rounded-lg col-span-1 md:col-span-2 h-[calc(66vh-5rem)] overflow-auto">
