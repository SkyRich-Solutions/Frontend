...
const MaterialPredictionsDashboard = () => {
  ...
  return (
    <div className="flex flex-col h-screen w-screen bg-gray-950 overflow-hidden">
      ...
      {/* Main Content - flexible height with consistent spacing */}
      <div className="flex-1 p-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 h-full">
          {/* Top row charts - consistent spacing */}
          {[0, 1, 2].map((index) => (
            <div
              key={index}
          ...
          {/* Two stacked charts on the left - consistent spacing */}
          ...
          {/* Two stacked tables on the right - consistent spacing */}
          <div className="flex flex-col gap-4 col-span-1 md:col-span-2 h-[calc(66vh-5rem)]">
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg border border-gray-700 p-4 flex-1 flex items-center justify-center rounded-lg">
            ...
            <div className="bg-gray-800 bg-opacity-50 backdrop-blur-md shadow-lg border border-gray-700 p-4 flex-1 rounded-lg overflow-hidden">
